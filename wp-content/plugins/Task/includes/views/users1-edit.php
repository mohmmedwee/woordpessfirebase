<div class="wrap">
    <h1><?php _e( 'Edit', 'wedevs' ); ?></h1>

    <?php $item = user_task_get_user( $id ); ?>
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr class="row-phone">
                    ...
                    <td>
                        <input type="text" name="phone" id="phone" class="regular-text" placeholder="<?php echo esc_attr( '', 'wedevs' ); ?>" value="<?php echo esc_attr( $item->phone ); ?>" required="required" />
                    </td>
                </tr>
                <tr class="row-email">
                    <th scope="row">
                    ...
                    <td>
                        <input type="text" name="email" id="email" class="regular-text" placeholder="<?php echo esc_attr( '', 'wedevs' ); ?>" value="<?php echo esc_attr( $item->email ); ?>" required="required" />
                    </td>
                </tr>
                <tr class="row-website">
                    ...
                    <td>
                        <input type="text" name="website" id="website" class="regular-text" placeholder="<?php echo esc_attr( '', 'wedevs' ); ?>" value="<?php echo esc_attr( $item->website ); ?>" />
                    </td>
                </tr>
...
<!--         <?php submit_button( __( 'Update', 'wedevs' ), 'primary', 'submit_user' ); ?>
 -->

<input type="submit" name="submit_user" id="submit_user" class="button button-primary" value="Update" onclick="writeUserData()">
    </form>
</div>
